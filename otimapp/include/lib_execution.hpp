...
// makespan
[[maybe_unused]] static int getMakespan(const Configs& result)
{
  return !result.empty() ? result.size() - 1 : 0;
}

// sum-of-costs
[[maybe_unused]] static int getSOC(const Configs& result)
{
...
[[maybe_unused]] static bool validateMAPFPlan(const Configs& configs,
                                              Problem* P)
{
